# ParlamentOpenData Golang SDK Reference

Complete API reference for the ParlamentOpenData Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *ParlamentOpenDataSDK`
...
#### `Business(data map[string]any) ParlamentOpenDataEntity`

Create a new `Business` entity instance. Pass `nil` for no initial data.

#### `Member(data map[string]any) ParlamentOpenDataEntity`

Create a new `Member` entity instance. Pass `nil` for no initial data.

#### `Session(data map[string]any) ParlamentOpenDataEntity`
...
fmt.Println(business.GetName()) // "business"
```
