...
func NewBusinessEntity(client *core.ParlamentOpenDataSDK, entopts map[string]any) *BusinessEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BusinessEntity) GetName() string { return e.name }
...
func (e *BusinessEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BusinessEntity) Deleted() bool {
	return e.deleted
}


func (e *BusinessEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBusinessEntity(e.client, opts)
}

func (e *BusinessEntity) Data(args ...any) any {
...
func (e *BusinessEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Business; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BusinessEntity) DataTyped(data ...Business) Business {
	if len(data) > 0 {
		return typedFrom[Business](e.Data(asMap(data[0])))
	}
	return typedFrom[Business](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Business (all fields
// optional at the wire level).
func (e *BusinessEntity) MatchTyped(match ...Business) Business {
	if len(match) > 0 {
		return typedFrom[Business](e.Match(asMap(match[0])))
	}
	return typedFrom[Business](e.Match())
}
...
func (e *BusinessEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BusinessEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *BusinessEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BusinessListMatch and returns []Business. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *BusinessEntity) ListTyped(reqmatch BusinessListMatch, ctrl map[string]any) ([]Business, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Business](res), nil
}



func (e *BusinessEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *BusinessEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BusinessEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BusinessEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
