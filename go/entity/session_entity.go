...
func NewSessionEntity(client *core.ParlamentOpenDataSDK, entopts map[string]any) *SessionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SessionEntity) GetName() string { return e.name }
...
func (e *SessionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SessionEntity) Deleted() bool {
	return e.deleted
}


func (e *SessionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSessionEntity(e.client, opts)
}

func (e *SessionEntity) Data(args ...any) any {
...
func (e *SessionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Session; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SessionEntity) DataTyped(data ...Session) Session {
	if len(data) > 0 {
		return typedFrom[Session](e.Data(asMap(data[0])))
	}
	return typedFrom[Session](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Session (all fields
// optional at the wire level).
func (e *SessionEntity) MatchTyped(match ...Session) Session {
	if len(match) > 0 {
		return typedFrom[Session](e.Match(asMap(match[0])))
	}
	return typedFrom[Session](e.Match())
}
...
func (e *SessionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SessionEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *SessionEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SessionListMatch and returns []Session. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *SessionEntity) ListTyped(reqmatch SessionListMatch, ctrl map[string]any) ([]Session, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Session](res), nil
}



func (e *SessionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SessionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SessionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SessionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
