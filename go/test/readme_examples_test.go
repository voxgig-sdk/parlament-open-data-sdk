...
const testSeed = `map[string]any{"entity": map[string]any{"business": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "member": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "session": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
