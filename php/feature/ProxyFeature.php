...
// ParlamentOpenData SDK proxy feature
...
class ParlamentOpenDataProxyFeature extends ParlamentOpenDataBaseFeature
{
    ...
    public function init(ParlamentOpenDataContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ParlamentOpenDataContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
