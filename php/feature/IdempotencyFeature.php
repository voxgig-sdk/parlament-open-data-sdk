...
// ParlamentOpenData SDK idempotency feature
...
class ParlamentOpenDataIdempotencyFeature extends ParlamentOpenDataBaseFeature
{
    ...
    private function _mutating(ParlamentOpenDataContext $ctx): bool
    {
