...
// ParlamentOpenData SDK telemetry feature
...
class ParlamentOpenDataTelemetryFeature extends ParlamentOpenDataBaseFeature
{
    ...
    private function _close(ParlamentOpenDataContext $ctx, bool $ok): void
    {
