...
// ParlamentOpenData SDK ratelimit feature
...
class ParlamentOpenDataRatelimitFeature extends ParlamentOpenDataBaseFeature
{
    ...
    private function _acquire(ParlamentOpenDataContext $ctx): void
    {
    ...
    private function _track(ParlamentOpenDataContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
