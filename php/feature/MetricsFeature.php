...
// ParlamentOpenData SDK metrics feature
...
class ParlamentOpenDataMetricsFeature extends ParlamentOpenDataBaseFeature
{
    ...
    private function _record(ParlamentOpenDataContext $ctx, bool $ok): void
    {
