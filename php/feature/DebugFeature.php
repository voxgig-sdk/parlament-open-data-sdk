...
// ParlamentOpenData SDK debug feature
...
class ParlamentOpenDataDebugFeature extends ParlamentOpenDataBaseFeature
{
    ...
    private function _finish(ParlamentOpenDataContext $ctx, bool $ok): void
    {
