...
// ParlamentOpenData SDK paging feature
...
class ParlamentOpenDataPagingFeature extends ParlamentOpenDataBaseFeature
{
    ...
    private function _is_list(ParlamentOpenDataContext $ctx): bool
    {
