...
// ParlamentOpenData SDK streaming feature
...
class ParlamentOpenDataStreamingFeature extends ParlamentOpenDataBaseFeature
{
    ...
    private function _iterate(ParlamentOpenDataResult $result): \Generator
    {
    ...
    private function _streamable(ParlamentOpenDataContext $ctx): bool
    {
