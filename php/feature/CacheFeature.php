...
// ParlamentOpenData SDK cache feature
...
class ParlamentOpenDataCacheFeature extends ParlamentOpenDataBaseFeature
{
    ...
    private function _through(ParlamentOpenDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
