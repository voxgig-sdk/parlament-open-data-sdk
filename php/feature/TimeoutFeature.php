...
// ParlamentOpenData SDK timeout feature
...
class ParlamentOpenDataTimeoutFeature extends ParlamentOpenDataBaseFeature
{
    ...
    private function _with_timeout(ParlamentOpenDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ParlamentOpenDataContext $_ctx, float $ms): void
    {
        $client = $this->client;
