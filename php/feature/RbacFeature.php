...
// ParlamentOpenData SDK rbac feature
...
class ParlamentOpenDataRbacFeature extends ParlamentOpenDataBaseFeature
{
    ...
    private function _required(ParlamentOpenDataContext $ctx): ?string
    {
    ...
    private function _reject(ParlamentOpenDataContext $ctx, string $required): void
    {
    ...
    private function _track(ParlamentOpenDataContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
