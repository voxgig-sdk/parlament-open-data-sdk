...
// ParlamentOpenData SDK utility: result_basic

class ParlamentOpenDataResultBasic
{
    public static function call(ParlamentOpenDataContext $ctx): ?ParlamentOpenDataResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof ParlamentOpenDataError) ? $result->err->msg : (string)$result->err;
