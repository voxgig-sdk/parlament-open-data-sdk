...
// ParlamentOpenData SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ParlamentOpenDataSDK::test)
...
{
    private const SDK_CLASS = 'ParlamentOpenDataSDK';
    ...
    private const SDK_BASE = 'parlamentopendata_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../parlamentopendata_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
