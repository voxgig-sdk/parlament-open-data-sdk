...
class BusinessDirectTest extends TestCase
{
    public function test_direct_list_business(): void
    {
        $setup = business_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-business", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
