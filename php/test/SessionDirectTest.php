...
class SessionDirectTest extends TestCase
{
    public function test_direct_list_session(): void
    {
        $setup = session_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-session", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
