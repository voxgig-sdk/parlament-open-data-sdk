...
// ParlamentOpenData SDK Session entity
...
class SessionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SessionEntity($this->_client, $opts);
    }

    /**
     * @param Session|array $args Session data (assoc-array) to store.
     */
    ...
    /**
     * @return Session|array The current Session data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Session fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Session fields).
     */
     ...
     *
     * @param SessionListMatch|array|null $reqmatch Match filter (any subset
     *   of Session fields) as an assoc-array; SessionListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Session[]|array A list of Session items as assoc-arrays at
