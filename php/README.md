...
The PHP SDK for the ParlamentOpenData API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Business(null)->list(null, null);
...
[$result, $err] = $client->ParlamentOpenData(null)->load(
    ["id" => "test01"], null
);
