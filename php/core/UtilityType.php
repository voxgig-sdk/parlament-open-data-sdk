...
// ParlamentOpenData SDK utility type

class ParlamentOpenDataUtility
{
    ...
    public static function copy(ParlamentOpenDataUtility $src): ParlamentOpenDataUtility
    {
        $u = new ParlamentOpenDataUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
