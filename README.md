...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/parlament-open-data` | `npm install @voxgig-sdk/parlament-open-data` |
| Python | `voxgig-sdk-parlament-open-data` | `pip install voxgig-sdk-parlament-open-data` |
| PHP | `voxgig-sdk/parlament-open-data` | `composer require voxgig-sdk/parlament-open-data` |
| Golang | `github.com/voxgig-sdk/parlament-open-data-sdk/go` | `go get github.com/voxgig-sdk/parlament-open-data-sdk/go` |
| Ruby | `voxgig-sdk-parlament-open-data` | `gem install voxgig-sdk-parlament-open-data` |
| Lua | `voxgig-sdk-parlament-open-data` | `luarocks install voxgig-sdk-parlament-open-data` |
