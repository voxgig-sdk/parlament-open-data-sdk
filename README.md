...
Provides machine-readable data on parliamentary activities in Switzerland, including legislative sessions, council members, and parliamentary proceedings.

Learn more about Parlament Open Data at [www.parlament.ch/de/%C3%BCber-das-parlament/fakten-und-zahlen/open-data-web-services/code-livestream](https://www.parlament.ch/de/%C3%BCber-das-parlament/fakten-und-zahlen/open-data-web-services/code-livestream).
...
This SDK exposes the API as a small set of **semantic entities** — Business, Member and Session — that you
...
const items = await client.Business().list()
```
...
| Go CLI | `github.com/voxgig-sdk/parlament-open-data-sdk/go-cli` | `go install github.com/voxgig-sdk/parlament-open-data-sdk/go-cli/cmd/parlament-open-data@latest` |
| Go MCP server | `github.com/voxgig-sdk/parlament-open-data-sdk/go-mcp` | `go get github.com/voxgig-sdk/parlament-open-data-sdk/go-mcp@latest` |
