...
describe("BusinessDirect", function()
  it("should direct-list-business", function()
    local setup = business_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-business", setup.live and "live" or "unit")
...
function business_direct_setup(mockres)
