...
describe("SessionDirect", function()
  it("should direct-list-session", function()
    local setup = session_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-session", setup.live and "live" or "unit")
...
function session_direct_setup(mockres)
