...
describe("MemberDirect", function()
  it("should direct-list-member", function()
    local setup = member_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-member", setup.live and "live" or "unit")
...
function member_direct_setup(mockres)
