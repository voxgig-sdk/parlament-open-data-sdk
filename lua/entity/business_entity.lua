...
BusinessEntity.__index = BusinessEntity


function BusinessEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, BusinessEntity)
  self._name = "business"
  self._client = client
...
function BusinessEntity:get_name()
  return self._name
end


function BusinessEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return BusinessEntity.new(self._client, opts)
end
...
function BusinessEntity:mark_deleted()
  self._deleted = true
end


function BusinessEntity:deleted()
  return true == self._deleted
end


function BusinessEntity:data_set(args)
  if args ~= nil then
...
function BusinessEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function BusinessEntity:match_set(args)
  if args ~= nil then
...
function BusinessEntity:match_get()
...
function BusinessEntity:stream(action, args, callopts)
...
---@param reqmatch BusinessListMatch
---@param ctrl? table
---@return Business[]
---@return string? err
function BusinessEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function BusinessEntity:_run_op(ctx, post_done)
  local utility = self._utility
