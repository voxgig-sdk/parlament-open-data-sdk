...
// ParlamentOpenData SDK audit feature
...
class ParlamentOpenDataAuditFeature extends ParlamentOpenDataBaseFeature
{
    ...
    private function _emit(ParlamentOpenDataContext $ctx, string $outcome): void
    {
