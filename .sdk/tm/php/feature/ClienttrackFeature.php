...
// ParlamentOpenData SDK clienttrack feature
...
class ParlamentOpenDataClienttrackFeature extends ParlamentOpenDataBaseFeature
{
    ...
    public function PostConstruct(ParlamentOpenDataContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'ParlamentOpenData-SDK';
