...
// ParlamentOpenData SDK netsim feature
...
class ParlamentOpenDataNetsimFeature extends ParlamentOpenDataBaseFeature
{
    ...
    private function _simulate(ParlamentOpenDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ParlamentOpenDataContext $ctx, array $applied): void
    {
        $client = $this->client;
