...
// ParlamentOpenData SDK utility: fetcher

class ParlamentOpenDataFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ParlamentOpenDataSDK/1.0)';
    ...
    public static function call(ParlamentOpenDataContext $ctx, string $fullurl, array $fetchdef): array
    {
