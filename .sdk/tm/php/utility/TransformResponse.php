...
// ParlamentOpenData SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class ParlamentOpenDataTransformResponse
{
    public static function call(ParlamentOpenDataContext $ctx): mixed
    {
        ...
        $transform = ParlamentOpenDataHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
