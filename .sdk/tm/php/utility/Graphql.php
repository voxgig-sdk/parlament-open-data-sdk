...
// ParlamentOpenData SDK utility: graphql
//
...
class ParlamentOpenDataGraphql
{
    ...
    // equivalent.
    public static function body(ParlamentOpenDataContext $ctx): mixed
    {
    ...
    public static function errors(ParlamentOpenDataContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
