...
class ParlamentOpenDataTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ParlamentOpenDataTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = ParlamentOpenDataTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = ParlamentOpenDataTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
