...
class MemberEntity
  ...
  # @return [Member, Hash] the current Member data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Member fields)
  def match_get
  ...
  #
  # @param reqmatch [MemberListMatch, Hash, nil] match filter (any subset of
  #   Member fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Member>, Array] the matching Member items; raises ParlamentOpenDataError on failure
