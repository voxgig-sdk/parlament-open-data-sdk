...
class SessionEntity
  ...
  def make
    opts = @_entopts.dup
    SessionEntity.new(@_client, opts)
  end
  ...
  # @return [Session, Hash] the current Session data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Session fields)
  def match_get
  ...
  #
  # @param reqmatch [SessionListMatch, Hash, nil] match filter (any subset of
  #   Session fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Session>, Array] the matching Session items; raises ParlamentOpenDataError on failure
