...
The Ruby SDK for the ParlamentOpenData API. Provides an entity-oriented interface using idiomatic Ruby conventions.
...
result, err = client.ParlamentOpenData(nil).load(
  { "id" => "test01" }, nil
)
