...
class SessionEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set PARLAMENTOPENDATA_TEST_SESSION_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def session_basic_setup(extra)
  ...
  entid_env_raw = ENV["PARLAMENTOPENDATA_TEST_SESSION_ENTID"]
