...
#      offline in seeded test mode (ParlamentOpenDataSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "ParlamentOpenData_sdk.rb")
  SDK_CLASS = "ParlamentOpenDataSDK"
  ...
  SDK_BASE = "ParlamentOpenData_sdk"
