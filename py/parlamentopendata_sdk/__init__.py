...
from parlamentopendata_sdk.utility import register
...
class ParlamentOpenDataSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = ParlamentOpenDataUtility()
    ...
    def get_utility(self):
        return ParlamentOpenDataUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ParlamentOpenDataSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Business(self, data=None) -> "BusinessEntity":
        ...
        from parlamentopendata_sdk.entity.business_entity import BusinessEntity
    ...
    def Member(self, data=None) -> "MemberEntity":
        ...
        from parlamentopendata_sdk.entity.member_entity import MemberEntity
    ...
    def Session(self, data=None) -> "SessionEntity":
        ...
        from parlamentopendata_sdk.entity.session_entity import SessionEntity
