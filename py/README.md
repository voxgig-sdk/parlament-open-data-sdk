# ParlamentOpenData Python SDK



The Python SDK for the ParlamentOpenData API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Business()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/parlament-open-data-sdk/releases)) or
...
```
py/
├── parlamentopendata_sdk.py         -- Main SDK module
