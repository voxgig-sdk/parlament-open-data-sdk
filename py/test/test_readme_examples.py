# ParlamentOpenData SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ParlamentOpenDataSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ParlamentOpenDataSDK(...) and ParlamentOpenDataSDK.test(...) become
#      ParlamentOpenDataSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "parlamentopendata_sdk"
_SDK_CLASS = "ParlamentOpenDataSDK"
