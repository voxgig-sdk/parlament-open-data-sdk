...
func registerSDKWords(r *eng.Registry, client *sdk.ParlamentOpenDataSDK) {
...
func runOp(client *sdk.ParlamentOpenDataSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
