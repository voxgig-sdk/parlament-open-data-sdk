// Command ParlamentOpenData-mcp is an MCP server exposing the ParlamentOpenData
// SDK as MCP tools.
//
// Two tools are registered:
//
//	ParlamentOpenData_list  — list records of an entity
//	ParlamentOpenData_load  — load a single record of an entity
//
