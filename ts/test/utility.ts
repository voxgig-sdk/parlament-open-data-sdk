...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.PARLAMENT_OPEN_DATA_TEST_LIVE ||
    'TRUE' === process.env.PARLAMENT_OPEN_DATA_TEST_OVERRIDE
  ) {
  ...
  m.PARLAMENT_OPEN_DATA_TEST_EXPLAIN = process.env.PARLAMENT_OPEN_DATA_TEST_EXPLAIN || m.PARLAMENT_OPEN_DATA_TEST_EXPLAIN
