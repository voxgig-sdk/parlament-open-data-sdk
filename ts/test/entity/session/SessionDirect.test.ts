...
describe('SessionDirect', async () => {
  ...
  test('direct-list-session', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-session', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['PARLAMENT_OPEN_DATA_TEST_SESSION_ENTID']
