...
The TypeScript SDK for the ParlamentOpenData API. Provides a type-safe, entity-oriented interface with full async/await support.
...
```ts
const client = new ParlamentOpenDataSDK({ apikey: '...' })
